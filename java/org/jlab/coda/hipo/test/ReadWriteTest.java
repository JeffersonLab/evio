...
public class ReadWriteTest {
    ...
    /**
     * Generate a buffer with CODA prestart event format data.
     * @param order byte order of generated data.
     * @return ByteBuffer with prestart event.
     */
    ...
    /**
     * Write a file using Writer with a dictionary, first event and trailer index,
     * in uncompressed form. Add junk data as an "event", write prestart event in
     * EvioNode form, and write out an entire Record.
     * @param finalFilename name of file.
     */
    ...
    /**
     * Just like {@link #writeFile(String)} except the WriterMT is used to write.
     * @param finalFilename name of file.
     */
