...
public class WriterNew implements AutoCloseable {
     ...
     */
    public WriterNew(ByteOrder order, int maxEventCount, int maxBufferSize){
     ...
     */
    public WriterNew(String filename) throws IOException {
        this();
        try {
            open(filename);
        }
     ...
     * @throws IOException  if file cannot be found or IO error writing to file
     */
    public WriterNew(String filename, ByteOrder order, int maxEventCount, int maxBufferSize)
            throws IOException {
    ...
    public final void open(String filename, byte[] userHeader)
        ...
        asyncFileChannel.write(headerBuffer, 0L);
