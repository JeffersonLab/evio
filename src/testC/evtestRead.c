...
#define MIN(a,b) (a<b)? a : b
    ...
    int main2()
    {
        ...
        status = evOpen("/Users/timmer/coda/evio/hipoTest.evio", "r", &handle);
        nevents = 0;
...
//        getchar();
        ...
        status = evClose(handle);
        //printf ("    Closed /home/timmer/evioTestFiles/evioV2format.ev again, status = %d\n\n", status);
        printf ("    Closed /Users/timmer/coda/evio/hipoTest.evio again, status = %d\n\n", status);
        return 0;
    }
