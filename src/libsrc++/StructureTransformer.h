...
namespace evio {
    ...
    public:
         ...
         */
        static std::shared_ptr<EvioBank> transform(std::shared_ptr<EvioSegment> segment, uint8_t num) {
         ...
         */
        static void copy(std::shared_ptr<EvioBank> bank,
                         std::shared_ptr<EvioSegment> segment,
                         uint8_t num) {
         ...
         * @return the created EvioBank.
         */
        static std::shared_ptr<EvioBank> transform(std::shared_ptr<EvioTagSegment> tagsegment, uint8_t num) {
         ...
         */
        static void copy(std::shared_ptr<EvioBank> bank,
                         std::shared_ptr<EvioTagSegment> tagsegment,
                         uint8_t num) {
         ...
         */
        static std::shared_ptr<EvioTagSegment> transform(std::shared_ptr<EvioSegment> segment) {
            auto const segHeader = segment->getHeader();
         ...
         * @param segment EvioSegment object to copy.
         */
        static void copy(std::shared_ptr<EvioTagSegment> tagsegment,
                         std::shared_ptr<EvioSegment> segment) {
         ...
         */
        static std::shared_ptr<EvioSegment> transform(std::shared_ptr<EvioTagSegment> tagsegment) {
         ...
         * @param tagsegment EvioTagSegment object to copy.
         */
        static void copy(std::shared_ptr<EvioSegment> segment,
                         std::shared_ptr<EvioSegment> tagsegment) {
         ...
         */
        static std::shared_ptr<EvioSegment> transform(std::shared_ptr<EvioBank> bank) {
         ...
         *
         * @param bank EvioBank object to transform.
         * @param dummy only used to distinguish this method from {@link #transform(std::shared_ptr<EvioBank>)}.
         * @return the created EvioTagSegment.
         * @throws EvioException if the bank is too long to change into a tagsegment
         */
        static std::shared_ptr<EvioTagSegment> transform(std::shared_ptr<EvioBank> bank,
                                                         int dummy) {
            auto const bankHeader = bank->getHeader();
